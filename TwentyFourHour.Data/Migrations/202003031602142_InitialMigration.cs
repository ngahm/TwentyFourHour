    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Post", t => t.CommentPostID, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Post", t => t.LikePostID, cascadeDelete: false)
                .ForeignKey("dbo.User", t => t.LikerID, cascadeDelete: false)
